    ...
    <div className={`${dark && "dark"}`}>
      <div className="dark:bg-slate-900 -mt-2">
        ...
        <div className="md:py-10">
          <div className="dark:bg-white-800 rounded-xl  md:w-5/12 md:mx-auto shadow-xl bg-teal-200 hover:bg-teal-300">
            <form ref={form} onSubmit={sendEmail} className="md:py-8 py-4 h-lvh">
              <label className="m-8 text-xl font-bold">Name : </label>
              <input
                type="text"
                name="from_name"
              ...
              />
              <br />
              <label className="m-8 text-xl font-bold ">Email : </label>
              <input
                type="email"
                name="from_email"
              ...
              />
              <br />
              <label className="m-8 text-xl font-bold ">Phone : </label>
              <input
                type="number"
                name="from_mob"
                className="md:mx-8 mx-10 rounded-lg md:my-10 my-4 md:w-96 w-52 h-12 border border-black p-4 hover:border-2 hover:bg-slate-100 font-medium font-serif"
              ...
              <div className="flex justify-items-center">
                ...
                <textarea
                  name="message"
                  className="mx-8 rounded-lg md:mb-10 md:mt-0 mt-4 md:w-96 w-72 md:h-40 h-52 border border-black p-4 hover:border-2 hover:bg-slate-100 font-medium font-serif"
              ...
              <input
                type="submit"
                value="SEND"
                className="font-extrabold font-serif rounded-lg mb-4 hover:scale-110 w-20 h-12 md:mx-72 mx-44 border-black  bg-blue-400 border hover:bg-blue-600"
              />
              <br />
            </form>
          </div>
