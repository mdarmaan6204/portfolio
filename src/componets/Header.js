    ...
    <div className={`${dark && "dark"} bg-slate-200 delay-150`}>
      <div className=" border-slate-500 dark:border-b-2 dark:bg-slate-800 dark:text-white flex justify-between px-2 py-4 mb-2 shadow-xl font-bold h-16">
        ...
        <ul className="flex mx-4">
          <Link to="/">
            <li className="mx-4 hover:bg-black hover:text-white hover:scale-110 w-16 h-8 rounded-xl px-2">
              Home
            </li>
          </Link>
          <Link to="/projects">
            <li className="mx-4   hover:bg-black hover:text-white hover:scale-110 w-20 h-8 rounded-xl px-2">
              Projects
            </li>
          </Link>
          <Link to="/about">
